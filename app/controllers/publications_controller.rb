class PublicationsController < ApplicationController
  ...
  before_action only: [:new, :create, :edit, :update, :destroy] do # dministradores pueden
  ...
  def show
    # Start *TODO: "Agregamos comentarios"
    @comment = Comment.new
    # Start *TODO: "Agregamos comentarios para mostrarlos"
  ...
  private
    ...
    def publication_params
      params.require(:publication).permit(:photo, :title, :description) # images: []
    end
end
